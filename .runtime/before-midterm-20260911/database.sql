...
(1,1,3,'张三','13800000003','东城区和平路 1 号','希望给小橘一个稳定家庭。','有照顾猫咪经验。','SUCCESS','领养成功','2026-09-04 23:59:10','2026-09-04 23:59:10'),
(2,7,3,'张三','13800000003','东城区和平路 1 号','奶糖性格很适合家里环境。','曾领养过流浪猫。','CANCELED','用户取消申请','2026-09-04 23:59:10','2026-09-04 23:59:10'),
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='领养审核日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(16,1,1,'PENDING','FIRST_APPROVED','FIRST_APPROVE','初审通过','2026-09-08 14:20:45'),
(17,1,1,'FIRST_APPROVED','INTERVIEWING','INTERVIEW','进入面谈','2026-09-08 14:20:48'),
(20,2,3,'FIRST_APPROVED','CANCELED','CANCEL','用户取消申请','2026-09-08 14:21:34'),
(23,1,1,'INTERVIEWING','TRIAL','TRIAL','进入试养','2026-09-08 14:23:42'),
(24,1,1,'TRIAL','SUCCESS','SUCCESS','领养成功','2026-09-08 14:24:22');
...
(1,'A-CAT-0001','小橘','CAT','MALE','YOUNG','橘色','健康','UNKNOWN','已接种基础疫苗','东城区','ADOPTED','亲人活泼，适合家庭领养。','/mock/animals/xiaoju-cover.png','2026-09-04 23:59:10','2026-09-05 15:55:01'),
...
(3,'A-CAT-0003','花花','CAT','UNKNOWN','BABY','三花','治疗中','UNKNOWN','未接种','朝阳区','TRIAL','有轻微皮肤问题，正在治疗。','/mock/animals/huahua-cover.png','2026-09-04 23:59:10','2026-09-05 15:55:01'),
...
(7,'A-CAT-0005','奶糖','CAT','FEMALE','YOUNG','奶牛色','健康','已绝育','已接种','东城区','ADOPTABLE','已有领养申请初审通过。','/mock/animals/naitang-cover.png','2026-09-04 23:59:10','2026-09-05 15:55:01'),
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='文件记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(4,'屏幕截图 2025-11-30 141618.png','e3d531c3dcd548a58cc75b692adac78b.png','/uploads/2026/09/08/e3d531c3dcd548a58cc75b692adac78b.png','C:\\Users\\31310\\Desktop\\animal\\backend\\uploads\\2026\\09\\08\\e3d531c3dcd548a58cc75b692adac78b.png','TASK_IMAGE',1,'image/png',51054,4,'2026-09-08 14:16:57'),
(5,'屏幕截图 2026-08-31 102611.png','7ed972fdee2e42b8807ba933564550ca.png','/uploads/2026/09/08/7ed972fdee2e42b8807ba933564550ca.png','C:\\Users\\31310\\Desktop\\animal\\backend\\uploads\\2026\\09\\08\\7ed972fdee2e42b8807ba933564550ca.png','ANIMAL_IMAGE',NULL,'image/png',834902,1,'2026-09-08 14:18:21');
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统通知表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(6,3,'领养申请初审通过','你的领养申请已初审通过，请等待后续面谈安排。','ADOPTION',0,'2026-09-08 14:20:45',NULL),
(7,3,'领养申请进入试养','你的领养申请已进入试养阶段。','ADOPTION',0,'2026-09-08 14:23:42',NULL),
(8,3,'领养申请成功','恭喜你，领养申请已成功。','ADOPTION',0,'2026-09-08 14:24:22',NULL),
(9,4,'新的救助工单','你有一个新的救助工单待处理：一食堂后门流浪猫救助','RESCUE_ORDER',0,'2026-09-11 09:10:41',NULL);
...
(1,1,'一食堂后门流浪猫救助','前往一食堂后门查看小橘和附近流浪动物情况。','一食堂后门','HIGH','ASSIGNED',1,4,NULL,NULL,'2026-09-11 09:00:03','2026-09-11 09:00:03',NULL),
(2,NULL,'3号宿舍楼下猫咪照护','前往3号宿舍楼下检查小黑的饮食和精神状态。','3号宿舍楼下','MEDIUM','WAIT_ASSIGN',1,NULL,NULL,NULL,'2026-09-11 09:00:03','2026-09-11 09:00:03',NULL),
(3,2,'图书馆北侧流浪动物救助','前往图书馆北侧核实并处理流浪动物救助线索。','图书馆北侧','MEDIUM','WAIT_ASSIGN',1,NULL,NULL,NULL,'2026-09-11 09:00:03','2026-09-11 09:00:03',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='工单流转日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,1,1,NULL,'WAIT_ASSIGN','CREATE','根据动物档案地点生成工单','2026-09-11 09:00:03'),
(2,2,1,NULL,'WAIT_ASSIGN','CREATE','根据动物档案地点生成工单','2026-09-11 09:00:03'),
(3,3,1,NULL,'WAIT_ASSIGN','CREATE','根据动物档案地点生成工单','2026-09-11 09:00:03'),
(12,1,1,'WAIT_ASSIGN','ASSIGNED','ASSIGN','','2026-09-11 09:10:41');
...
CREATE TABLE `sys_user` (
  ...
  `create_time` datetime NOT NULL DEFAULT current_timestamp() COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '更新时间',
  `student_id` varchar(50) DEFAULT NULL COMMENT '志愿者学号',
  `real_name` varchar(50) DEFAULT NULL COMMENT '志愿者真实姓名',
  `major` varchar(100) DEFAULT NULL COMMENT '志愿者专业',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_sys_user_username` (`username`),
  KEY `idx_sys_user_phone` (`phone`),
  KEY `idx_sys_user_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'admin','$2a$10$5M1HJMdyJw4EgEthKEm7/O2fsAsjqL0UNWlsOJlFMF8RB5tDCFxwq','超级管理员','13800000000','admin@example.com',NULL,1,'2026-09-11 09:10:11','2026-09-04 23:59:10','2026-09-11 09:10:11',NULL,NULL,NULL),
(2,'volunteer','$2a$10$908hel0J5WCpg7D6b8VS0.cUKk4j8RFKYoXRgfynAtLKwbUuQ6vsK','志愿者测试账号','13800000002','volunteer@example.com',NULL,1,'2026-09-05 16:19:28','2026-09-04 23:59:10','2026-09-05 16:19:29',NULL,NULL,NULL),
(3,'user','$2a$10$rhZIFvXpYU7K0VQPy.AkXuOXZMFqx4GvSUtyk/8oqjhmPFGp/p502','普通用户测试账号','13800000003','user@example.com',NULL,1,'2026-09-08 14:29:49','2026-09-04 23:59:10','2026-09-08 14:29:49',NULL,NULL,NULL),
(4,'111111','$2a$10$.JoX8VIjcX6hfKbBMbEhnuHbm0jMgkNGjgkzWNApc.3ze99rUYFjK','','','',NULL,1,'2026-09-11 09:10:47','2026-09-08 14:13:01','2026-09-11 09:10:47','2023211704','刘','计算机');
...
(1,'一食堂后门巡查与补给','FEEDING','在一食堂后门巡查动物状态并补充猫粮和清水。','一食堂后门','WAIT_CLAIM',1,NULL,NULL,NULL,NULL,0,'2026-09-11 09:00:03','2026-09-11 09:00:03'),
(2,'3号宿舍楼下猫屋清理','CLEANING','清理3号宿舍楼下猫屋并更换干净垫布。','3号宿舍楼下','WAIT_CLAIM',1,NULL,NULL,NULL,NULL,0,'2026-09-11 09:00:03','2026-09-11 09:00:03'),
(3,'图书馆北侧动物救助协助','TEMP_RESCUE','协助核实图书馆北侧动物情况并联系救助人员。','图书馆北侧','WAIT_CLAIM',1,NULL,NULL,NULL,NULL,0,'2026-09-11 09:00:03','2026-09-11 09:00:03');
...
--
-- Dumping events for database 'stray_animal'
--
...
-- Dump completed on 2026-09-14  8:27:58
