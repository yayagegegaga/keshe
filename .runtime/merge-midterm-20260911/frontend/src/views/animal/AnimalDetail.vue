        ...
        <el-card shadow="never">
          <div class="detail">
            ...
            <el-descriptions :column="2" border>
              ...
              <el-descriptions-item label="性别">{{ dict(ANIMAL_GENDER, animal.gender) }}</el-descriptions-item>
              <el-descriptions-item label="年龄">{{ dict(ANIMAL_AGE, animal.ageStage) }}</el-descriptions-item>
