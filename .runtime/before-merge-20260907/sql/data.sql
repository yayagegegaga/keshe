...
VALUES
    (1, 'A-CAT-0001', '小橘', 'CAT', 'MALE', 'YOUNG', '橘色', '健康', 'UNKNOWN', '已接种基础疫苗', '东城区', 'ADOPTABLE', '亲人活泼，适合家庭领养。', '/mock/animals/xiaoju-cover.png'),
    (2, 'A-CAT-0002', '小黑', 'CAT', 'FEMALE', 'ADULT', '黑色', '观察中', 'UNKNOWN', 'UNKNOWN', '西城区', 'OBSERVING', '刚救助入站，正在观察饮食和精神状态。', '/mock/animals/xiaohei-cover.png'),
    (3, 'A-CAT-0003', '花花', 'CAT', 'UNKNOWN', 'BABY', '三花', '治疗中', 'UNKNOWN', '未接种', '朝阳区', 'TREATING', '有轻微皮肤问题，正在治疗。', '/mock/animals/huahua-cover.png'),
    (4, 'A-DOG-0001', '旺财', 'DOG', 'MALE', 'ADULT', '黄色', '待检查', 'UNKNOWN', 'UNKNOWN', '海淀区', 'WAIT_RESCUE', '社区居民上报，仍在现场等待救助。', '/mock/animals/wangcai-cover.png'),
    (5, 'A-CAT-0004', '小白', 'CAT', 'FEMALE', 'OLD', '白色', '稳定', '已绝育', '已接种', '丰台区', 'ADOPTED', '已完成领养，后续将进入回访流程。', '/mock/animals/xiaobai-cover.png'),
    (6, 'A-DOG-0002', '豆包', 'DOG', 'FEMALE', 'YOUNG', '棕白', '健康', 'UNKNOWN', '已接种基础疫苗', '通州区', 'ADOPTABLE', '性格温顺，适合提交领养申请测试。', '/mock/animals/doubao-cover.png'),
    (7, 'A-CAT-0005', '奶糖', 'CAT', 'FEMALE', 'YOUNG', '奶牛色', '健康', '已绝育', '已接种', '东城区', 'APPLYING', '已有领养申请初审通过。', '/mock/animals/naitang-cover.png'),
    (8, 'A-DOG-0003', '来福', 'DOG', 'MALE', 'ADULT', '黑棕', '健康', 'UNKNOWN', '已接种', '朝阳区', 'APPLYING', '领养申请已进入面谈。', '/mock/animals/laifu-cover.png'),
    (9, 'A-CAT-0006', '糯米', 'CAT', 'MALE', 'ADULT', '白灰', '稳定', '已绝育', '已接种', '海淀区', 'TRIAL', '当前处于试养阶段。', '/mock/animals/nuomi-cover.png')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    type = VALUES(type),
