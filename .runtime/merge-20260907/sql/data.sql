...
VALUES
    (1, 'A-CAT-0001', '小橘', 'CAT', 'MALE', 'YOUNG', '橘色', '健康', 'UNKNOWN', '已接种基础疫苗', '东城区', 'ADOPTABLE', '亲人活泼，适合家庭领养。', '/mock/animals/xiaoju-cover.jpg'),
    (2, 'A-CAT-0002', '小黑', 'CAT', 'FEMALE', 'ADULT', '黑色', '观察中', 'UNKNOWN', 'UNKNOWN', '西城区', 'OBSERVING', '刚救助入站，正在观察饮食和精神状态。', '/mock/animals/xiaohei-cover.jpg'),
    (3, 'A-CAT-0003', '花花', 'CAT', 'UNKNOWN', 'BABY', '三花', '治疗中', 'UNKNOWN', '未接种', '朝阳区', 'TREATING', '有轻微皮肤问题，正在治疗。', '/mock/animals/huahua-cover.jpg'),
    (4, 'A-DOG-0001', '旺财', 'DOG', 'MALE', 'ADULT', '黄色', '待检查', 'UNKNOWN', 'UNKNOWN', '海淀区', 'WAIT_RESCUE', '社区居民上报，仍在现场等待救助。', '/mock/animals/wangcai-cover.jpg'),
    (5, 'A-CAT-0004', '小白', 'CAT', 'FEMALE', 'OLD', '白色', '稳定', '已绝育', '已接种', '丰台区', 'ADOPTED', '已完成领养，后续将进入回访流程。', '/mock/animals/xiaobai-cover.jpg'),
    (6, 'A-DOG-0002', '豆包', 'DOG', 'FEMALE', 'YOUNG', '棕白', '健康', 'UNKNOWN', '已接种基础疫苗', '通州区', 'ADOPTABLE', '性格温顺，适合提交领养申请测试。', '/mock/animals/doubao-cover.jpg'),
    (7, 'A-CAT-0005', '奶糖', 'CAT', 'FEMALE', 'YOUNG', '奶牛色', '健康', '已绝育', '已接种', '东城区', 'APPLYING', '已有领养申请初审通过。', '/mock/animals/naitang-cover.jpg'),
    (8, 'A-DOG-0003', '来福', 'DOG', 'MALE', 'ADULT', '黑棕', '健康', 'UNKNOWN', '已接种', '朝阳区', 'APPLYING', '领养申请已进入面谈。', '/mock/animals/laifu-cover.jpg'),
    (9, 'A-CAT-0006', '糯米', 'CAT', 'MALE', 'ADULT', '白灰', '稳定', '已绝育', '已接种', '海淀区', 'TRIAL', '当前处于试养阶段。', '/mock/animals/nuomi-cover.jpg')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    type = VALUES(type),
...
VALUES
    (1, 1, '/mock/animals/xiaoju-cover.jpg', 'COVER'),
    (2, 1, '/mock/animals/xiaoju-detail.jpg', 'DETAIL'),
    (3, 2, '/mock/animals/xiaohei-cover.jpg', 'COVER'),
    (4, 3, '/mock/animals/huahua-health.jpg', 'HEALTH'),
    (5, 4, '/mock/animals/wangcai-rescue.jpg', 'RESCUE'),
    (6, 5, '/mock/animals/xiaobai-cover.jpg', 'COVER')
ON DUPLICATE KEY UPDATE
...
VALUES
    (1, 1, '健康', '社区合作宠物医院', '完成基础体检，精神和食欲正常。', '2026-06-01 10:00:00', '可进入领养展示'),
    (2, 2, '观察中', '救助站观察室', '入站观察，暂未发现明显外伤。', '2026-06-05 14:30:00', '继续观察三天'),
    (3, 3, '治疗中', '安心宠物医院', '皮肤清洁和外用药处理。', '2026-06-08 09:20:00', '一周后复查'),
    (4, 4, '待检查', '现场待救助', '暂未接触，等待志愿者协助。', '2026-06-10 16:00:00', '注意安全'),
    (5, 5, '稳定', '社区合作宠物医院', '老年猫基础体检，状态稳定。', '2026-05-28 11:10:00', '已领养')
ON DUPLICATE KEY UPDATE
    health_status = VALUES(health_status),
...
VALUES
    (1, 3, 'CAT', '东城区和平路小区门口', '发现一只橘猫疑似受伤，行动缓慢。', 'HIGH', '/mock/rescue/clue-1.jpg', '13800000003', 'PENDING', NULL, NULL),
    (2, 3, 'DOG', '海淀区学院路公交站', '流浪犬长时间徘徊，已转救助工单。', 'MEDIUM', '/mock/rescue/clue-2.jpg', '13800000003', 'CONVERTED', 1, '线索有效，已创建工单'),
    (3, 3, 'OTHER', '朝阳区公园北门', '疑似误报，现场未发现动物。', 'LOW', NULL, '13800000003', 'INVALID', 1, '现场核实无效')
ON DUPLICATE KEY UPDATE
...
VALUES
    (1, 2, '公交站流浪犬救助', '根据线索前往公交站处理流浪犬。', '海淀区学院路公交站', 'MEDIUM', 'WAIT_ASSIGN', 1, NULL, NULL, NULL, NULL),
    (2, NULL, '社区投喂点临时救助', '社区发现猫咪疑似生病，需要志愿者协助。', '西城区社区投喂点', 'HIGH', 'ASSIGNED', 1, 2, NULL, NULL, NULL),
    (3, NULL, '桥下幼猫救助', '桥下发现幼猫，志愿者已到场处理中。', '朝阳区河边桥下', 'HIGH', 'PROCESSING', 1, 2, NULL, NULL, NULL),
    (4, NULL, '小区门口猫咪救助关闭样例', '已完成现场处理并关闭。', '东城区和平路小区门口', 'LOW', 'CLOSED', 1, 2, '已完成基础检查并送至救助站。', '/mock/rescue/order-4-result.jpg', '2026-06-15 18:30:00')
ON DUPLICATE KEY UPDATE
    title = VALUES(title),
    description = VALUES(description),
    location = VALUES(location),
...
VALUES
    (1, '东城区投喂点补粮', 'FEEDING', '为固定投喂点补充猫粮和清水。', '东城区和平路投喂点', 'WAIT_CLAIM', 1, NULL, NULL, NULL, NULL, 0),
    (2, '西城区猫屋清理', 'CLEANING', '清理社区猫屋并更换垫布。', '西城区社区猫屋', 'CLAIMED', 1, 2, '2026-06-12 09:00:00', NULL, NULL, 1),
    ...
    (5, '临时救助协助任务', 'TEMP_RESCUE', '原计划协助临时救助，因线索取消同步取消任务。', '朝阳区公园北门', 'CANCELED', 1, NULL, NULL, NULL, '线索取消，任务取消', 1)
ON DUPLICATE KEY UPDATE
    title = VALUES(title),
...
VALUES
    (1, 1, 3, '张三', '13800000003', '东城区和平路 1 号', '希望给小橘一个稳定家庭。', '有照顾猫咪经验。', 'PENDING', NULL),
    (2, 7, 3, '张三', '13800000003', '东城区和平路 1 号', '奶糖性格很适合家里环境。', '曾领养过流浪猫。', 'FIRST_APPROVED', '初审资料基本符合'),
    (3, 8, 3, '张三', '13800000003', '东城区和平路 1 号', '希望领养来福陪伴家人。', '有养犬经验。', 'INTERVIEWING', '已安排面谈'),
    (4, 9, 3, '张三', '13800000003', '东城区和平路 1 号', '糯米比较亲人，愿意试养。', '家中环境适合猫咪。', 'TRIAL', '进入试养阶段'),
    (5, 5, 3, '张三', '13800000003', '东城区和平路 1 号', '愿意长期照顾小白。', '了解老年猫照护。', 'SUCCESS', '领养成功')
ON DUPLICATE KEY UPDATE
