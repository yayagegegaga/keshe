  ...
  <main class="auth-page">
    <section class="panel">
      ...
      <div class="tab-switch">
        <el-button 
          :type="registerType === 'user' ? 'primary' : 'default'"
          plain
        ...
        <el-button 
          :type="registerType === 'volunteer' ? 'primary' : 'default'"
          plain
      ...
      >
        ...
        <el-form-item label="用户名" prop="username">
          <el-input v-model="form.username" placeholder="4-30位字母或数字" />
        </el-form-item>
