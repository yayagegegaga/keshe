    ...
    <section class="shell">
      <div class="header">
        <div>
          ...
          <p class="subtitle">第八阶段：权限补强、业务绑定、统计完善和前端体验统一。</p>
        </div>
      ...
      <div class="grid">
        <el-card shadow="never" class="stats-card">
          ...
          <div class="stats-grid" v-if="statistics">
            <!-- ===== 所有用户可见 ===== -->
            <div class="clickable-item" @click="goToAnimalList" title="点击查看全部动物列表">
              <strong>{{ statistics.animalCount }}</strong>
              <span>动物总数</span>
            </div>

            <div class="clickable-item" @click="goToAdoptableAnimals" title="点击查看可领养动物列表">
              <strong>{{ statistics.adoptableAnimalCount }}</strong>
              <span>可领养动物</span>
            </div>

            <div class="clickable-item" @click="goToNotifications" title="点击查看我的通知">
            ...
            <template v-if="isAdmin">
              <!-- 待审核线索 → 线索审核 -->
              <div class="clickable-item" @click="goToClueManage" title="点击进入线索审核">
                <strong>{{ statistics.pendingClueCount }}</strong>
                <span>待审核线索</span>
              </div>

              <!-- 任务总数 → 任务管理 -->
              <div class="clickable-item" @click="goToTaskManage" title="点击进入任务管理">
              ...
              <!-- 申请总数 → 领养审核 -->
              <div class="clickable-item" @click="goToAdoptionManage" title="点击进入领养审核">
